...
# <HINT> Create a submit view to create an exam submission
# record for a course enrollment,
...
# An example method to collect the selected choices from 
# the exam form from the request object
...
# passed exam and show their question results and result 
# for each question,
